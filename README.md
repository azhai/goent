...
./bin/goent-gen fields ./example/models
# view file ./example/models/fields.go
```
...
1. Add `//go:generate goent-gen fields .` to your models package:
...
```bash
go generate fields ./models
```

3. This creates `fields.go` with:
