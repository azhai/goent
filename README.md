...
# OR build from go source code:
git clone --depth=1 https://github.com/azhai/goent.git
cd goent/ && go mod tidy && make
cp ./bin/goent-gen $GOPATH/bin/goent-gen
```

2. Generate tables and fields

**Command-line flags:**
for both actions
- Set the database connection string as the GOE_DATABASE_DSN environment variable
- `--force`: Force overwrite existing generated files (default: creates backup with timestamp)
for tables action
- `--dsn`: Database connection string (required for tables action, can use `GOE_DATABASE_DSN` env var)
...
export GOE_DATABASE_DSN="postgres://user:pass@localhost/db?sslmode=false"

# use goent-gen to generate tables and fields
goent-gen tables --schema 'public' --prefix 't_' --force ./models
goent-gen fields --force ./models

# OR use go generate from conn.go
cat > ./models/conn.go <<EOD
//go:generate goent-gen tables --prefix 't_' --dsn \$GOE_DATABASE_DSN --force ./
...
|-----------------|---------|--------:|----------:|----------:|--------------:|----------:|
| **insert**      | raw-pgx |   14774 |     83884 |       321 |             9 |         = |
|                 | raw     |   14674 |     86620 |       576 |            11 |      3.2% |
|                 | goent   |   15094 |     82290 |      1180 |            28 |     -2.0% |
|                 | goe     |   14842 |     78911 |      2596 |            29 |     -6.0% |
| **insert-bulk** | raw-pgx |     169 |   8384795 |   5374593 |         39827 |         = |
|                 | raw     |     163 |   8074567 |   6053086 |         39829 |     -3.7% |
|                 | goent   |     181 |   7601021 |   6703339 |         40025 |     -9.4% |
|                 | goe     |     175 |   7048442 |   5202123 |         28011 |    -16.0% |
| **update**      | raw-pgx |   14616 |     84370 |       345 |            11 |         = |
|                 | raw     |   15324 |     80854 |       648 |            13 |     -4.2% |
|                 | goent   |   14674 |     82648 |      1427 |            29 |     -2.1% |
|                 | goe     |   15024 |     76673 |      2546 |            26 |     -9.2% |
| **delete**      | raw-pgx |   14929 |     81987 |       146 |             5 |         = |
|                 | raw     |   14601 |     85839 |       208 |             7 |      4.6% |
|                 | goent   |  534078 |      2464 |      3061 |            21 |    -97.0% |
|                 | goe     |   48093 |     25021 |      1003 |            14 |    -69.5% |
| **select-one**  | raw-pgx |   52670 |     22550 |       980 |            15 |         = |
|                 | raw     |   49026 |     24373 |      1656 |            41 |      8.0% |
|                 | goent   |   48289 |     24583 |      1051 |            14 |      9.0% |
|                 | goe     |   42412 |     28228 |      3411 |            46 |     25.1% |
| **select-page** | raw-pgx |     747 |   1600640 |     52359 |           680 |         = |
|                 | raw     |    3116 |    385832 |     56720 |          1270 |    -75.9% |
|                 | goent   |    3616 |    325279 |     48698 |           880 |    -79.7% |
|                 | goe     |    3526 |    332879 |     54280 |           790 |    -79.3% |
